...
namespace tpr\framework\route;

use tpr\framework\Container;
use tpr\framework\Request;
use tpr\framework\Response;
use tpr\framework\route\dispatch\Callback as CallbackDispatch;
use tpr\framework\route\dispatch\Controller as ControllerDispatch;
use tpr\framework\route\dispatch\Module as ModuleDispatch;
use tpr\framework\route\dispatch\Redirect as RedirectDispatch;
use tpr\framework\route\dispatch\Response as ResponseDispatch;
use tpr\framework\route\dispatch\View as ViewDispatch;
...
abstract class Rule
{
     ...
     * @return Dispatch|ResponseDispatch
     * @throws \Exception
     */
