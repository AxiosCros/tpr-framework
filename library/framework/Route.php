...
use tpr\framework\route\AliasRule;
use tpr\framework\route\Dispatch;
use tpr\framework\route\dispatch\Url as UrlDispatch;
use tpr\framework\route\Domain;
use tpr\framework\route\Resource;
use tpr\framework\route\RuleGroup;
use tpr\framework\route\RuleItem;
...
class Route
{
     ...
     * @return UrlDispatch|false|Route|Dispatch
