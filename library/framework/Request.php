...
class Request
{
    ...
    /**
     * 当前调度信息
     * @var \tpr\framework\route\Dispatch
     */
    protected $dispatch;
     ...
     * 设置或者获取当前请求的调度信息
     * @access public
     * @param  \tpr\framework\route\Dispatch  $dispatch 调度信息
     * @return \tpr\framework\route\Dispatch
     */
