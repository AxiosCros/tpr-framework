...
class Build
{
     ...
     * @return string
     */
    protected function getControllerRoute(\ReflectionClass $class, $module, $controller)
    {
        $content = '';
    ...
    protected function buildHello($module, $namespace, $suffix = false)
    {
        ...
        if (!is_file($filename)) {
            $content = file_get_contents($this->app->getFrameworkPath() . 'tpl' . DIRECTORY_SEPARATOR . 'default_index.tpl');
