...
namespace tpr\framework\console\output\driver;

use tpr\framework\console\Output;
use tpr\framework\console\output\Formatter;
    ...
    public function renderException(\Exception $e)
    {
        ...
        do {
            ...
            foreach (preg_split('/\r?\n/', $e->getMessage()) as $line) {
                foreach ($this->splitStringByWidth($line, $width - 4) as $l) {

                    $lineLength = $this->stringWidth(preg_replace('/\[[^m]*m/', '', $l)) + 4;
                    $lines[]    = [$l, $lineLength];
